export default function Programs() {
  return (
    <main className="min-h-screen">
      ...
      {/* Card for Init Build*/}
      <div className="mt-12">
        <div className="dark:border-none-700 w-1/2 max-w-sm rounded-lg border border-gray-200 bg-white shadow dark:bg-gray-800 md:w-1/4">
          <a href="#">
            <img
      ...
      <div className="mt-12">
        <div className="dark:border-none-700 w-1/2 max-w-sm rounded-lg border border-gray-200 bg-white shadow dark:bg-gray-800 md:w-1/4">
          ...
          <div className="p-5">
            ...
            <p className="text-none-700 dark:text-none-400 mb-3 font-normal">
              INIT Reach is a program focused on the hardware development side
              of technology. Using all sorts of machinery, large or small, this
              program aims inspire members to create their own devices with the
              technology available today.
            </p>
            <a
              href="#"
              className="inline-flex items-center rounded-lg bg-blue-500 px-3 py-2 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-red-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Read more
              <svg
                className="ml-2 h-3.5 w-3.5"
