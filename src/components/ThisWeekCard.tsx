export default function ThisWeekCard() {
  return (
    <div className="mb-20 mt-20 gap-4 px-4 md:grid md:grid-cols-2 md:px-0">
      <div className="flex items-center justify-center md:ml-40 md:justify-start">
        <div>
      ...
      <div className="mt-8 md:mt-0">
        <div>
          <h6 className="text-white-900 text-3xl font-medium dark:text-white">
        ...
        <div>
          <h6 className="text-white-900 mt-7 text-3xl font-medium dark:text-white">
